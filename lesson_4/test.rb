...
loop do
  ...
  names = full_name.split #Genere un array qui contient prenom et nom

  names_counter = 0
  loop do #boucle pour passer en Capitalize Prenom et Nom dans l'array names
  ...
  capitalized_full_name = names.join(' ') #réécris le Prénom et Nom capitalizé dans la base
...
loop do #Si subscriber && date < 60J , on ajoute la hash client dans usable_leads
  break if counter == mailing_campaign_leads.size
